...
describe('DegreeController', () => {
  ...
  describe('getDegreeWithRoadmap', () => {
    it('should return a degree with roadmap', async () => {
      ...
      jest
          .spyOn(degreeService, 'getDegrees')
          .mockImplementation(
    ...
    it('should return not found', async () => {
      ...
      await expect(() =>
        degreeController.getDegreeById(1, false),
      ).rejects.toThrow(new NotFoundException(`Degree with id 1 not found`));
    });
  });
});
