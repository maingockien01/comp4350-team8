...
describe('CourseService', () => {
	...
	describe('getCourses', () => {
		it('should make request to repository with criterias and return an Array type', async () => {
			...
			expect(await courseService.getCourses(criterias)).toBeInstanceOf(Array);
		});
		...
		it('should make request to repository with relations and return an Array type', async () => {
			...
			expect(await courseService.getCourses(criterias, relations)).toBeInstanceOf(Array);
		});
